/*
 ...
 Source Host           : 101.34.146.196:3306
...
CREATE TABLE `gateway_admin`  (
  ...
  `is_delete` tinyint(4) NOT NULL DEFAULT 1 COMMENT '是否删除 1 未删除 2删除',
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `gateway_admin` VALUES (1, 'admin', 'admin', '2823d896e9822c0833d41d4904f0c00756d718570fce49b9a379a62c804689d3', '2020-04-10 16:42:05', '2020-04-21 06:35:08', 1);
INSERT INTO `gateway_admin` VALUES (2, 'admin2', 'admin', '2823d896e9822c0833d41d4904f0c00756d718570fce49b9a379a62c804689d3', '2020-04-10 16:42:05', '2020-04-21 06:35:08', 1);
...
-- ----------------------------
INSERT INTO `gateway_app` VALUES (31, 'app_id_a', '租户A', '449441eb5e72dca9c42a12f3924ea3a2', 'white_ips', 100000, 100, '2020-04-15 20:55:02', '2020-04-21 07:23:34', 1);
INSERT INTO `gateway_app` VALUES (32, 'app_id_b', '租户B', '8d7b11ec9be0e59a36b52f32366c09cb', '', 20, 0, '2020-04-15 21:40:52', '2020-04-21 07:23:27', 1);
INSERT INTO `gateway_app` VALUES (33, 'app_id', '租户名称', '', '', 0, 0, '2020-04-15 22:02:23', '2020-04-15 22:06:51', 2);
INSERT INTO `gateway_app` VALUES (34, 'app_id45', '名称', '07d980f8a49347523ee1d5c1c41aec02', '', 0, 0, '2020-04-15 22:06:38', '2020-04-15 22:06:49', 2);
...
CREATE TABLE `gateway_service_access_control`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 192 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '网关权限控制表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `gateway_service_http_rule`  (
  ...
  `header_transfor` varchar(5000) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT 'header转换支持增加(add)、删除(del)、修改(edit) 格式: add headname headvalue 多个逗号间隔',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 183 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '网关路由匹配表' ROW_FORMAT = Dynamic;
...
INSERT INTO `gateway_service_http_rule` VALUES (181, 62, 0, '/fff', 0, 0, 0, '', '');
INSERT INTO `gateway_service_http_rule` VALUES (182, 63, 0, '/xxx', 0, 0, 0, '', '');
...
CREATE TABLE `gateway_service_info`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 64 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '网关基本信息表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of gateway_service_info
-- ----------------------------
INSERT INTO `gateway_service_info` VALUES (34, 0, 'websocket_test', 'websocket_test', '2022-01-13 22:52:58', '1971-01-01 00:00:00', 2);
INSERT INTO `gateway_service_info` VALUES (35, 1, 'test_grpc', 'test_grpc', '2022-01-16 21:15:27', '1971-01-01 00:00:00', 2);
INSERT INTO `gateway_service_info` VALUES (36, 2, 'test_httpe', 'test_httpe', '2022-01-16 21:15:38', '1971-01-01 00:00:00', 2);
INSERT INTO `gateway_service_info` VALUES (38, 0, 'service_name', '11111', '2022-01-16 21:15:50', '2020-04-11 23:59:39', 2);
INSERT INTO `gateway_service_info` VALUES (41, 0, 'service_name_tcp', '11111', '2020-04-13 01:38:01', '2020-04-12 01:06:09', 1);
INSERT INTO `gateway_service_info` VALUES (42, 0, 'service_name_tcp2', '11111', '2022-01-16 21:14:02', '2020-04-12 01:13:24', 2);
...
INSERT INTO `gateway_service_info` VALUES (56, 0, 'test_http_service', '测试HTTP代理', '2020-04-16 00:54:45', '2020-04-15 07:55:07', 1);
INSERT INTO `gateway_service_info` VALUES (57, 1, 'test_tcp_service', '测试TCP代理', '2020-04-19 14:03:09', '2020-04-15 07:58:39', 1);
INSERT INTO `gateway_service_info` VALUES (58, 2, 'test_grpc_service', '测试GRPC服务', '2020-04-21 07:20:16', '2020-04-15 07:59:46', 1);
INSERT INTO `gateway_service_info` VALUES (59, 0, 'test.com:8080', '测试域名接入', '2020-04-18 22:54:14', '2020-04-18 20:29:13', 1);
INSERT INTO `gateway_service_info` VALUES (60, 0, 'test_strip_uri', '测试路径接入', '2020-04-21 06:55:26', '2020-04-18 22:56:37', 1);
INSERT INTO `gateway_service_info` VALUES (61, 0, 'test_https_server', '测试https服务', '2020-04-19 12:22:33', '2020-04-19 12:17:04', 1);
INSERT INTO `gateway_service_info` VALUES (62, 0, 'aaaaaa', '123456787654wa', '2022-01-15 13:27:04', '2022-01-15 13:27:04', 1);
INSERT INTO `gateway_service_info` VALUES (63, 0, 'bbbbbb', '123456787654wa', '2022-01-15 13:32:37', '2022-01-15 13:32:37', 1);
...
CREATE TABLE `gateway_service_load_balance`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 192 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '网关负载表' ROW_FORMAT = Dynamic;
...
INSERT INTO `gateway_service_load_balance` VALUES (190, 62, 0, 0, 0, 0, '127.0.0.1:80', '50', '', 0, 0, 0, 0);
INSERT INTO `gateway_service_load_balance` VALUES (191, 63, 0, 0, 0, 0, '127.0.0.1:80', '50', '', 0, 0, 0, 0);
